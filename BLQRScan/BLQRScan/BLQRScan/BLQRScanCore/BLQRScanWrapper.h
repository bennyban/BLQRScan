...
/**
 @brief  封装ZXing和ios系统自带原生扫码功能，ZXing识别图片二维码以及生成二维码功能，识别码类型,AVMetadataObjectTypeQRCode：二维码AVMetadataObjectTypeEAN13Code/AVMetadataObjectTypeEAN8Code：条形码
 */
@interface BLQRScanWrapper : NSObject
